...
def main():
    ...
    section = st.sidebar.radio("Go to section", ["Image Processing", "Image Morphing", "Text to Image"])
    ...
    if section == "Image Processing":
        ...
        if uploaded_file is not None:
            ...
            if choice == "None":
                ...
                # Region-Based Methods Code
                pass

    elif section == "Image Morphing":
        # Leave this section blank for now
        st.write("Image Morphing Section (Coming Soon)")

    elif section == "Text to Image":
        # Leave this section blank for now
        st.write("Text to Image Section (Coming Soon)")
