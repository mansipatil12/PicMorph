...
def main():
    ...
    st.sidebar.subheader("This is a web app to perform conversion of text to image, performs image morphing and learn about image processing techniques on a given input image.")
    if st.sidebar.button("ℹ️ More Info"):
        switch_page("About and Techniques")

    st.sidebar.title("👨🏽‍💻Developer")
    st.sidebar.info(
        "This app is created by **Mansi Patil , Nandini Rathod, Saurabh Sharma**\n"
    )
    ########################################
